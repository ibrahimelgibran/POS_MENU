...
import com.elgibran.iegcodeposv2.gui.dialog.au.JDialogCategoryAU;
 ...
 */
public class JDialogCategory extends javax.swing.JDialog implements MouseListener {
    ...
    public JDialogCategory(JFrameCafSys jFrameCafSys, boolean modal) {
...
//        jTextFieldSearch.putClientProperty( "JComponent.roundRect",true );
    ...
    private void jButtonNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNewActionPerformed
        JDialogCategoryAU categoryAU = new JDialogCategoryAU(jFrameCafSys, true);
        categoryAU.setVisible(true);
        selectCategory();
    }//GEN-LAST:event_jButtonNewActionPerformed

    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        JDialogCategoryAU categoryAU = new JDialogCategoryAU(jFrameCafSys, true, category, "Update");
        categoryAU.setVisible(true);
        selectCategory();
        jButtonDelete.setEnabled(false);
        jButtonUpdate.setEnabled(false);
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        JDialogCategoryAU categoryAU = new JDialogCategoryAU(jFrameCafSys, true, "Delete", category);
        categoryAU.setVisible(true);
        jButtonDelete.setEnabled(false);
        jButtonUpdate.setEnabled(false);
  ...
  DefaultTableModel tableModel = new DefaultTableModel(new Object[]{"ID", "CATEGORY", "DESCRIPTION"}, 0);
    ...
    private void setTable() {
        ...
        TableColumn hide0 = jTableCategory.getColumnModel().getColumn(0);
        hide0.setMinWidth(0);
        hide0.setMaxWidth(0);
    ...
    private void selectCategory() {
        ...
        categotyList = categoryDAOImpl.selectCategory();
        tableModel.setRowCount(0);
        for (Category c : categotyList) {
            tableModel.addRow(new Object[]{c.getId(), c.getCategory(), c.getDescription()});
        }
    ...
    public void mouseClicked(MouseEvent e) {
        if (e.getSource() == jTableCategory) {
            if (e.getButton() == MouseEvent.BUTTON1) {
                if (e.getClickCount() == 1) {
                    int row = jTableCategory.getSelectedRow();
                    if (row != -1) {
                        Long userId = Long.parseLong(jTableCategory.getValueAt(row, 0).toString());
                        String course = jTableCategory.getValueAt(row, 1).toString();
                        String description = jTableCategory.getValueAt(row, 2).toString();
                        Category c = new Category();
                        c.setId(userId);
                        c.setCategory(course);
                        c.setDescription(description);
                        Category uat = categoryDAOImpl.findPhotoByCategoryId(c);
                        c.setPhoto(uat.getPhoto());
                        this.category = c;
