 ...
 */
package com.elgibran.iegcodeposv2.gui.dialog.au;


import com.elgibran.iegcodeposv2.IegcodePosv2;
import com.elgibran.iegcodeposv2.dao.impl.RoleDAOImpl;
import com.elgibran.iegcodeposv2.dao.impl.UserAccountDAOImpl;
...
import com.elgibran.iegcodeposv2.util.ComboBoxList;
...
public class JDialogUserAccountAU extends javax.swing.JDialog {
        ...
        try {
            ...
            if (returnVal == javax.swing.JFileChooser.APPROVE_OPTION) {
                ...
                try {
                    ...
                    ImageIO.write(resizedImage, "png", new File(IegcodePosv2.class.getProtectionDomain().getCodeSource().getLocation().getPath() + "\\images\\model.jpg"));
    ...
    private void validatePhoto() throws URISyntaxException {
        if (userAccount.getPhoto() == null) {
            File targetClassesDir = new File(IegcodePosv2.class.getProtectionDomain().getCodeSource().getLocation().getPath() + "\\images\\no photo.jpg");
            try {
