...
import com.elgibran.iegcodeposv2.dao.TodaysMenuDAO;
...
//            c.closeConnection();
    ...
    public LinkedList<TodaysMenu> getMenuByCategoryIdMenuId(Long id) {
        LinkedList<TodaysMenu> list = new LinkedList<>();
        try {
            String query = "SELECT \n"
                    + "    TODAYS_MENU.ID,\n"
